...
class ActionTellTime(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, 
        ...
        if not tz_string:
            msg = f"I didn't recognize {current_place}. It is spelled correctly?"
            dispatcher.utter_message(text=msg)
            return []
...
class ActionTimeDifference(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if not timezone_to:
            msg = "I didn't get the timezone, you'd like to compare against. Are you sure it's spelled correct."
            dispatcher.utter_message(text=msg)
            return []
